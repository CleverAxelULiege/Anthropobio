    ...
    return (
        <nav className={styles.nav}>
            <div className={styles.buttonContainer}>
                <a className={styles.button} onClick={(e) => { e.preventDefault(); setTab(TABS.home) }} href={`?tab=${TABS.home}`}>
                ...
                <button id="expert_mode_button" onClick={() => { setExpertMode(!expertMode) }} className={styles.button} style={{ marginLeft: "auto", minWidth: "350px" }}>
